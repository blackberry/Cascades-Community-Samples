...
#ifndef APPROVAL_OUTCOME_RESP_HPP_
#define APPROVAL_OUTCOME_RESP_HPP_
#include "OperationAl.hpp"

class Q_DECL_EXPORT OpApprovalOutcomeResp : public OperationAl {

public:
	OpApprovalOutcomeResp();
	~OpApprovalOutcomeResp();
...
#endif /* APPROVAL_OUTCOME_RESP_HPP_ */
