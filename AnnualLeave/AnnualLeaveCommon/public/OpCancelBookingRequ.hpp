...
#ifndef CANCEL_BOOKING_REQU_HPP_
#define CANCEL_BOOKING_REQU_HPP_
#include "OperationAl.hpp"
#include <QString>

class Q_DECL_EXPORT OpCancelBookingRequ : public OperationAl {
...
#endif /* CANCEL_BOOKING_REQU_HPP_ */
