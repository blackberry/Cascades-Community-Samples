...
#ifndef CANCEL_BOOKING_RESP_HPP_
#define CANCEL_BOOKING_RESP_HPP_
#include "OperationAl.hpp"

class Q_DECL_EXPORT OpCancelBookingResp : public OperationAl {
...
#endif /* CANCEL_BOOKING_RESP_HPP_ */
