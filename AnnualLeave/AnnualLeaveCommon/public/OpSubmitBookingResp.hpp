...
#ifndef SUBMIT_BOOKING_RESP_HPP_
#define SUBMIT_BOOKING_RESP_HPP_
#include "OperationAl.hpp"

class Q_DECL_EXPORT OpSubmitBookingResp : public OperationAl {
...
public:
	...
	int requestStatus();
	void setRequestStatus(int request_status);
...
#endif /* SUBMIT_BOOKING_RESP_HPP_ */
