...
#ifndef UPDATE_BOOKING_RESP_HPP_
#define UPDATE_BOOKING_RESP_HPP_
#include "OperationAl.hpp"

class Q_DECL_EXPORT OpUpdateBookingResp : public OperationAl {
...
#endif /* UPDATE_BOOKING_RESP_HPP_ */
