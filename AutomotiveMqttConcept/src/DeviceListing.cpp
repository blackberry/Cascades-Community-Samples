    ...
    if (remoteDeviceArray) {
        ...
        for (int i = 0; (nextRemoteDevice = remoteDeviceArray[i]); ++i) {
            ...
            if (isAHeartRateMonitor(nextRemoteDevice)) {
                ...
                hrdc->setCurrentDeviceName(QString::fromLatin1(buffer));
                ...
                hrdc->setCurrentDeviceAddr(QString::fromLatin1(buffer));
				...
				// EMIT A SIGNAL TO START MONITORING USING THIS DEVICE
