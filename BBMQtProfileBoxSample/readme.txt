...
Demonstrates how to update the ProfileBox for the application shown in the user's BlackBerry
Messenger Profile using the Qt style BBM SP library.  Also demonstrates the creation of ProfileBox.  
This samples uses the Cascades and Qt style BlackBerry Messenger Social Platform APIs.
...
BlackBerry Messenger Social Platform ProfileBox
BlackBerry Messenger Social Platform ProfileBox Items
