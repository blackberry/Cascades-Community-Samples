...
CustomListItem {
    ...
    Container {
        ...
        Label {
            text: ListItemData.messages.topic.subject[".data"]
            multiline: true
        ...
        Container {
            ...
            Container {
                ...
                Label {
                    text: ListItemData.messages.topic.author.login[".data"]
                    textStyle.color: Color.DarkGreen
                    textStyle.base: SystemDefaults.TextStyles.SubtitleText
                }
                Label {
                    text: ListItemData.messages.count[".data"] - ListItemData.messages.read.count[".data"] 
                    textStyle.color: Color.DarkGreen
                    textStyle.base: SystemDefaults.TextStyles.SubtitleText
                }
                Label {
                    text: formatDate(ListItemData.messages.topic.last_edit_time[".data"])
                    textStyle.color: Color.DarkGreen
                    textStyle.base: SystemDefaults.TextStyles.SubtitleText
                }
            }
    ...
    onCreationCompleted: {
        ...
        boardProperties.getBoardName(ListItemData.messages.topic.board["href"]);
    }    
