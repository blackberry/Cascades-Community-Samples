...
CustomListItem {
    ...
    Container {
        ...
        Container {
            ...
            ImageButton {
                id: acceptSolutionButton
                defaultImageSource: "asset:///images/ic_add_favorite.png"
                accessibility.name: qsTr("Accept as Solution")
                visible: false
    ...
    contextActions: [
        ActionSet {
            ...
            ActionItem {
                id: acceptSolutionAction
                title: qsTr("Accept as Solution")
    ...
    attachedObjects: [
        ...
        SystemDialog {
            id: acceptSolutionDialog
            title: qsTr("Accept Solution?")
            body: qsTr("Are you sure you wish to accept this post as the solution?")
            onFinished: {
                if (acceptSolutionDialog.result == SystemUiResult.ConfirmButtonSelection)
                    messageWorker.markAsSolution(ListItemData.id[".data"]);
            }
    ...
    onCreationCompleted: {
        ...
        if (forumThreadItem.ListItem.view.canMarkSolved())
        {
            acceptSolutionAction.enabled = true;
            acceptSolutionButton.visible = true;
        }
    }
    ...
    function doAcceptSolution()
    {
        acceptSolutionDialog.show();
    }    
