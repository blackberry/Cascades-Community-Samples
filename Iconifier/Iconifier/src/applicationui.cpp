...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("Iconifier_%1").arg(locale_string);
...
void ApplicationUI::resendNotification()
{
    ...
    request.setTarget("com.example.IconifierService");
    request.setAction("com.example.IconifierService.RESET");
