...
This sample shows how to use the built in internationalization engine 
to deliver your app in multiple languages.

In this sample application, you will learn:
--In the QT .pro file, how to add the language files to be supported.
--In C++ code, how to install/use an appropriate QTranslator object basing on the selected locale.
