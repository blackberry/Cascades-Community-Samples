...
This sample shows how to handle an exception, log it and then display meaningful data back to the user.


In this example application, you will learn:

	--how to subclass bb::Exception to create custom Exception
	--how to locate the application log and retrieve the content of the log file.
