...
ScrollView {
    ...
    Container {
        ...
        layout: DockLayout {
        } // to allow docking of decoration relative to the row element
        Container {
            id: background
        ...
        Label {
            ...
            textStyle {
                ...
                color: {
                    console.log("XXXX log item colour=" + _item.colour_code);
                    console.log("XXXX log item desc  =" + _item.description);
                    if (_item.colour_code != "") {
                        Color.create(_item.colour_code);
                    }
                }
                lineHeight: 1.1
            }
