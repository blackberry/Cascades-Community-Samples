...
The purpose of this application is to demonstrate in as simple an appliation as possible, the Qt property system that allows the integration of C++ data with QML.
