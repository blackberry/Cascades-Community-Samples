# SmsMessageService -- User directed SMS

The purpose of this application is to demonstrate how to use the BlackBerry 10 messaging APIs to send and receive user directed SMS messages and delivery receipts from within a BlackBerry 10 native application. 
