Lightning Crossfade - Text & Image

========================================================================
Sample Description.
 
 Use a slider to crossfade between two images. 
 
 You will learn how to:
 - Add images to a UI
 - Use layouts with several UI elements
 - Add a slider and listen to slider events
 - Do all of the above in QML
